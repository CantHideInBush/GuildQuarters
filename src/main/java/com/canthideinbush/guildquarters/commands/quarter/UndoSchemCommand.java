...
public class UndoSchemCommand extends InternalCommand implements ABArgumentCompletion {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        quarter.getQuarterObjects().removeSchematic(schematic);
    ...
    private static final String SUCCESS = "Cofnieto schemat!";
