...
public class RemoveRedirectionPortal extends InternalCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        if (!guildQuarter.getQuarterObjects().hasRPortal(portal)) {
            sendConfigErrorMessage(sender, "common.redirection-portal-not-added");
            return false;
        }

        guildQuarter.getQuarterObjects().removeRPortal(portal);
