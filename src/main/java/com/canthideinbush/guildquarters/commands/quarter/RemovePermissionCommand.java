...
public class RemovePermissionCommand extends InternalCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        if ((quarter = CommandUtility.getQuarter(name, sender, this)) == null) return false;

        String permission = args[getArgIndex() + 1].toLowerCase();
        quarter.getSharedPermissions().remove(permission);
    ...
    private static final String SUCCESS = "Pomyslnie usunieto uprawnienie!";
